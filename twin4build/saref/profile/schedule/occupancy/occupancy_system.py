...
class OccupancySystem(base.Schedule, System):
    ...
    def initialize(self,
        ...
        modeled_damper_position_sensor = next(iter(group[damper_position_sensor_node]))
        ...
        modeled_co2_sensor = next(iter(group[co2_sensor_node]))
