...
from twin4build.utils.pass_input_sum_to_output import PassInputSumToOutput
...
class SummingSensorSystem(Sensor):
    ...
    def set_do_step_instance(self):
        if self.isPhysicalSystem:
            ...
            self.do_step_instance = PassInputSumToOutput(id="pass input to output")
