...
def get_signature_pattern():
    ...
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="BuildingSpace1AdjBoundaryOutdoorFMUSystem", priority=160)
...
def get_signature_pattern_sensor():
    ...
    node9 = Node(cls=core.S4BLDG.BuildingSpace)
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="BuildingSpace1AdjBoundaryOutdoorFMUSystem", priority=159)
...
class BuildingSpace1AdjBoundaryOutdoorFMUSystem(fmu_component.FMUComponent):
