...
def get_signature_pattern():
    ...
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="BuildingSpace2AdjBoundaryOutdoorFMUSystem", priority=210)
...
def get_signature_pattern_sensor():
    ...
    node9 = Node(cls=core.S4BLDG.BuildingSpace)
    node10 = Node(cls=core.S4BLDG.BuildingSpace)
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="BuildingSpace2AdjBoundaryOutdoorFMUSystem", priority=209)
...
class BuildingSpace2AdjBoundaryOutdoorFMUSystem(fmu_component.FMUComponent):
