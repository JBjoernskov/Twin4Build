...
def get_signature_pattern():
    ...
    node7 = Node(cls=core.SAREF.Temperature)
    node8 = Node(cls=core.S4BLDG.BuildingSpace)
    ...
    sp = SignaturePattern(ownedBy="BuildingSpace11AdjBoundaryFMUSystem", priority=500)
...
class BuildingSpace11AdjBoundaryFMUSystem(fmu_component.FMUComponent):
