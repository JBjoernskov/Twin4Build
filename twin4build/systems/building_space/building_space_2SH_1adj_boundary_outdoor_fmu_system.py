...
def get_signature_pattern():
    ...
    node10 = Node(cls=core.S4BLDG.Valve) #supply valve
    node11 = Node(cls=core.S4BLDG.SpaceHeater)
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="BuildingSpace2SH1AdjBoundaryOutdoorFMUSystem", priority=200)
    ...
    sp.add_triple(Exact(subject=node10, object=node2, predicate=core.S4BLDG.isContainedIn))
    sp.add_triple(Exact(subject=node11, object=node2, predicate=core.S4BLDG.isContainedIn))
    sp.add_triple(Exact(subject=node10, object=node11, predicate=core.FSO.suppliesFluidTo))
...
class BuildingSpace2SH1AdjBoundaryOutdoorFMUSystem(fmu_component.FMUComponent):
    """
    ...
    def __init__(self,
        ...
        Args:
            ...
            fraRad_sh (float, optional): The fraction of radiation of space heater. Defaults to None.
            Q_flow_nominal_sh (float, optional): The nominal heat flow rate of space heater. Defaults to None.
            T_a_nominal_sh (float, optional): The nominal supply air temperature of space heater. Defaults to None.
            T_b_nominal_sh (float, optional): The nominal return air temperature of space heater. Defaults to None.
            TAir_nominal_sh (float, optional): The nominal air temperature of space heater. Defaults to None.
            n_sh (float, optional): The nominal heat transfer coefficient of space heater. Defaults to None.
