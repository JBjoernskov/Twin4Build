...
def get_flow_signature_pattern_after_coil_air_side():
    ...
    sp.add_triple(Exact(subject=node0, object=node1, predicate=core.namespace.SAREF.observes))
    sp.add_triple(Exact(subject=node5, object=node2, predicate=core.namespace.FSO.suppliesFluidTo))
    sp.add_triple(Exact(subject=node2, object=node6, predicate=core.namespace.FSO.returnsFluidTo))
    sp.add_triple(Exact(subject=node7, object=node3, predicate=core.namespace.FSO.suppliesFluidTo))
    sp.add_triple(Exact(subject=node3, object=node8, predicate=core.namespace.FSO.suppliesFluidTo))
    sp.add_triple(Exact(subject=node2, object=node4, predicate=core.namespace.S4SYST.subSystemOf))
    sp.add_triple(Exact(subject=node3, object=node4, predicate=core.namespace.S4SYST.subSystemOf))
    sp.add_triple(SinglePath(subject=node3, object=node0, predicate=core.namespace.FSO.suppliesFluidTo))
...
def get_flow_signature_pattern_after_coil_water_side():
    ...
    sp.add_triple(Exact(subject=node2, object=node4, predicate=core.namespace.S4SYST.subSystemOf))
    sp.add_triple(Exact(subject=node3, object=node4, predicate=core.namespace.S4SYST.subSystemOf))
    sp.add_triple(SinglePath(subject=node2, object=node0, predicate=core.namespace.FSO.returnsFluidTo))
...
def get_flow_signature_pattern_before_coil_water_side():
    ...
    sp.add_triple(Exact(subject=node2, object=node4, predicate=core.namespace.S4SYST.subSystemOf))
    sp.add_triple(Exact(subject=node3, object=node4, predicate=core.namespace.S4SYST.subSystemOf))
    sp.add_triple(SinglePath(subject=node2, object=node0, predicate=core.namespace.FSO.hasFluidSuppliedBy))
...
def get_space_temperature_signature_pattern():
    ...
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="SensorSystem")
    sp.add_triple(Exact(subject=node0, object=node1, predicate=core.namespace.SAREF.observes))
    sp.add_triple(Exact(subject=node1, object=node2, predicate=core.namespace.SAREF.isPropertyOf))
...
def get_position_signature_pattern():
    ...
    node2 = Node(cls=(core.namespace.S4BLDG.Valve, core.namespace.S4BLDG.Damper,))
    node3 = Node(cls=(core.namespace.S4BLDG.Controller))
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="SensorSystem")
    sp.add_triple(Exact(subject=node0, object=node1, predicate=core.namespace.SAREF.observes))
    sp.add_triple(Exact(subject=node1, object=node2, predicate=core.namespace.SAREF.isPropertyOf))
    sp.add_triple(Exact(subject=node3, object=node1, predicate=core.namespace.SAREF.controls))
...
def get_temperature_before_air_to_air_supply_side():
    ...
    sp.add_triple(Exact(subject=node0, object=node1, predicate=core.namespace.SAREF.observes))
    sp.add_triple(SinglePath(subject=node2, object=node0, predicate=core.namespace.FSO.hasFluidSuppliedBy))
    sp.add_triple(Exact(subject=node2, object=node9, predicate=core.namespace.S4SYST.subSystemOf))
...
def get_temperature_before_air_to_air_exhaust_side():
    ...
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="SensorSystem")
    sp.add_triple(Exact(subject=node0, object=node1, predicate=core.namespace.SAREF.observes))
    sp.add_triple(SinglePath(subject=node0, object=node2, predicate=core.namespace.FSO.returnsFluidTo))
    sp.add_triple(Exact(subject=node2, object=node9, predicate=core.namespace.S4SYST.subSystemOf))
...
def get_temperature_after_air_to_air_supply_side():
    ...
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="SensorSystem")
    sp.add_triple(Exact(subject=node0, object=node1, predicate=core.namespace.SAREF.observes))
    sp.add_triple(Exact(subject=node0, object=node2, predicate=core.namespace.FSO.hasFluidSuppliedBy))
    sp.add_triple(Exact(subject=node2, object=node9, predicate=core.namespace.S4SYST.subSystemOf))
...
def get_temperature_after_air_to_air_exhaust_side():
    ...
    sp = SignaturePattern(semantic_model_=core.ontologies, ownedBy="SensorSystem")
    sp.add_triple(Exact(subject=node0, object=node1, predicate=core.namespace.SAREF.observes))
    sp.add_triple(Exact(subject=node2, object=node0, predicate=core.namespace.FSO.returnsFluidTo))
    sp.add_triple(Exact(subject=node2, object=node9, predicate=core.namespace.S4SYST.subSystemOf))
...
class SensorSystem(core.System):
    ...
    def __init__(self,
        ...
        self.output = {"measuredValue": tps.Scalar(0)} # TODO: Not necessary to be a leaf scalar, if the sensor has inputs. Need to implement check in initialize()
    ...
    def initialize(self,
        ...
        if self.filename is not None or self.df is not None or self.dbconfig is not None:
            if self.df is None:
                assert self.useSpreadsheet == True or self.useDatabase == True, "useSpreadsheet or useDatabase must be True if df is not provided."
            self.physicalSystem = TimeSeriesInputSystem(id=f"time series input - {self.id}", 
                                                        df=self.df,
            ...
            self.physicalSystem.initialize(startTime=startTime,
                                            endTime=endTime,
                                            stepSize=stepSize,
                                            simulator=simulator)
        ...
        assert (len(self.connectsAt)==0 and self.physicalSystem is None)==False, \
            f'Sensor object "{self.id}" has no inputs and and holds no data.'
