    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.waterFlowRateMax = tps.Parameter(
            torch.tensor(waterFlowRateMax, dtype=tps.float_dtype()),
            requires_grad=False,
            scaling="log",
        )
        self.valveAuthority = tps.Parameter(
            torch.tensor(valveAuthority, dtype=tps.float_dtype()), requires_grad=False
        )
...
ValveSystem.add_signature_pattern(brick_signature_pattern_space_heater_command())
ValveSystem.add_signature_pattern(brick_signature_pattern_room_heating_command())
