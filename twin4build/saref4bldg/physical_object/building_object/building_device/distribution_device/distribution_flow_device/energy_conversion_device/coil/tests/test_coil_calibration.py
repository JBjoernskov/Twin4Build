...
def test():
    ...
    VE02_supply_air = load_spreadsheet(filename=filename, stepSize=stepSize, start_time=startTime, end_time=endTime, dt_limit=9999)
    ...
    # input.insert(3, "coil inlet water temperature sensor", VA01_FTF1_SV["FTF1_SV"])
