...
from twin4build.api.codes.ml_layer.whatif_scenario.what_if_input_data import input_data
...
class what_if_request_class:
    ...
    def get_configuration(self):       
        ...
        try:
            ...
            config_path = os.path.join(os.path.abspath(
                uppath(os.path.abspath(__file__), 5)), "config", "conf.ini")
    ...
    def what_if_request_to_simulator_api(self,start_time,end_time,time_with_warmup,forecast):
        try :
            ...
            if input_validater:
                ...
                if response.status_code == 200:
                    ...
                    if response_validater:
                        ...
                        table_to_add_data = "ml_what_if_results"
