...
class Model:
    ...
    #     # Filter for debigging
    #     classes = [cls for cls in classes if cls is components.BuildingSpace1AdjBoundaryOutdoorFMUSystem] ##################################################
    #     complete_groups = {}
    #     incomplete_groups = {}
    #     counter = 0
    ...
    def _connect(self):
        def copy_nodemap(nodemap):
            # CHANGED: Simplified copy since we're no longer copying sets
