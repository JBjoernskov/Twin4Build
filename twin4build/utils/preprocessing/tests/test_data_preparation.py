...
filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 4)), "test", "data", "time_series_data", "VE02.pickle")
filehandler = open(filename, 'rb')
df_VE02 = pickle.load(filehandler)


filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 4)), "test", "data", "time_series_data", "OE20_601b_2.pickle")
filehandler = open(filename, 'rb')
