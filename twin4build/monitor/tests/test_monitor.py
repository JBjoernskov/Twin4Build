...
def test():
    ...
    # startPeriod = datetime.datetime(year=2022, month=10, day=23, hour=0, minute=0, second=0) ## Commissioning case
    # endPeriod = datetime.datetime(year=2022, month=11, day=6, hour=0, minute=0, second=0) ## Commissioning case 11 15
    ...
    # endPeriod = datetime.datetime(year=2022, month=1, day=15, hour=0, minute=0, second=0) #piecewise 20.5-23
    ...
    # startPeriod = datetime.datetime(year=2022, month=2, day=15, hour=0, minute=0, second=0) ## Scenario case
    # endPeriod = datetime.datetime(year=2022, month=2, day=28, hour=0, minute=0, second=0) ## Scenario case

    # startPeriod = datetime.datetime(year=2022, month=12, day=1, hour=0, minute=0, second=0, tzinfo=tzutc()) ## Scenario case
    # endPeriod = datetime.datetime(year=2023, month=1, day=28, hour=0, minute=0, second=0, tzinfo=tzutc()) ## Scenario case
