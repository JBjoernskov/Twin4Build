...
def plot_timeseries_data(data, title="Timeseries Data", max_plots_per_figure=5):
    ...
    for fig_idx, chunk in enumerate(chunks):
        ...
        fig, axes = plt.subplots(
            chunk_size, 1, figsize=(12, 3 * chunk_size), sharex=True
        )
        if chunk_size == 1:
            axes = [axes]
...
def plot_scatter(
    data_x, data_y, label_x, label_y, title="Scatter Plot", max_points=10000
):
    """
    ...
    print(
        f"  X-axis ({label_x}): {combined.iloc[:, 0].min():.2f} to {combined.iloc[:, 0].max():.2f}"
    )
    print(
        f"  Y-axis ({label_y}): {combined.iloc[:, 1].min():.2f} to {combined.iloc[:, 1].max():.2f}"
    )
    ...
    ax.scatter(
        combined_display.iloc[:, 0], combined_display.iloc[:, 1], alpha=0.5, s=10
    )
...
if __name__ == "__main__":
    ...
    sensor_ids = [
        ...
        sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
        + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.0d760e87_4d3f_4b5a_8580_8a5fc28d0113",  # Enable status
        ...
        [
            sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
            + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.e3794860_91e1_4d33_b59e_6d32b3608901.cc4b2230_9874_4b09_92d4_3b0fd4ff9318",  # min temp setpoint
            sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
            + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.7204a748_bc51_4070_bb1e_4a50b901df00",  # Discharge
            sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
        ...
        sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
        + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.e3794860_91e1_4d33_b59e_6d32b3608901.d851e5bd_1766_4aae_a571_d5070bcc3493",  # temperature setpoint
        ...
        sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
        + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.ac15587f_8b12_478f_bba8_652bfd9b9fd2",  # return damper
        sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
        + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.36ab6c42_36b6_45af_a65e_fbd6d119b6f4",  # outside damper
        sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
        + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.0feaf9d9_924e_42dc_9bfc_aad29a54d56f",  # heationg valve
        sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
        + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.f81f9843_b9c5_45ba_b1fc_00ecb34928ff",  # coolling valve
        [
            sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
            + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.eb67d269_f4a3_40c0_851e_66bd89efb0da",  # room air temperature setpoint
            sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
            + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.4b524f12_0c6f_4abd_a677_51db619f635f",  # average room air temperature
            sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
            + "c10f79c9_744d_40a5_a272_7cde7ca1f5a6.fb20d0cb_185c_4d94_b1a1_37df9bc44074",  # heating temperature setpoiint]
            sm.namespaces["p33f3e0c2_f2cd_471c_b5a0_4655c2bd4623".upper()]
            ...
            if isinstance(sensor_item, list):
                ...
                for sensor_uuid in sensor_item:
                    ...
                    try:
                        ...
                        sensor_type = (
                            sensor_type + " | " + str(sensor_uuid).split(".")[-1][:8]
                        )
    ...
    if do_symbolic_regression:
        ...
        feature_sensors = {
            ...
            "heating_temp_setpoint": NS
            + f"{AHU_PREFIX}.fb20d0cb_185c_4d94_b1a1_37df9bc44074",
        ...
        print(
            f"   Value range: {y_df.iloc[:, 0].min():.2f} to {y_df.iloc[:, 0].max():.2f}"
        )
        ...
        for feature_name, feature_uuid in feature_sensors.items():
            ...
            try:
                ...
                print(
                    f"     Loaded {len(df)} points, range: {df.iloc[:, 0].min():.2f} to {df.iloc[:, 0].max():.2f}"
                )
        ...
        print("-" * 80)
        try:
            enable_status_sensor_id, enable_status_type = get_sensor_id(
                sm, enable_status_uuid
            )
            ...
            print(
                f"   Value range: {enable_status_df.iloc[:, 0].min():.2f} to {enable_status_df.iloc[:, 0].max():.2f}"
            )
            print(
                f"   Enabled timesteps: {(enable_status_df.iloc[:, 0] > 0).sum()} / {len(enable_status_df)}"
            )
        ...
        if "_enable_status_filter" in combined_df.columns:
            ...
            print(
                f"   Data points after filtering: {after_filter} (removed {before_filter - after_filter} disabled timesteps)"
            )
        ...
        print(
            f"   Data points after removing first row (NaN due to lag): {after_lag_drop} (removed {before_lag_drop - after_lag_drop})"
        )
        ...
        try:
            ...
            print(
                "You may also need to install Julia first: https://julialang.org/downloads/"
            )
