...
def main():
    ...
    torch_model_instance.add_connection(Q_sh_torch, torch_model, "scheduleValue", "Q_sh")
    ...
    torch_model_instance.add_connection(T_boundary_torch, torch_model, "scheduleValue", "T_boundary")
    ...
    fmu_model_instance.add_connection(T_boundary_fmu, fmu_model, "scheduleValue", "T_boundary")
