...
def main():
    ...
    for name, comp in [("Building space", space), ("Space heater", space_heater),
                        ...
                        ("Exhaust damper", exhaust_damper), ("Occupancy", occupancy_system),
    ...
    parameters = [
        # Thermal parameters
        (space, "thermal.C_air", 5e+5, 1e+4, 5e+5),
        (space, "thermal.C_wall", 1e+6, 1e+5, 3e+6),
        ...
        (space_heater, "thermalMassHeatCapacity", 1e+4, 1000, 2e+5),
    ...
    fig, axes = tb.plot.plot(
        ...
        [tb.plot.Entry(model.components["office_temperature_sensor"].time_series_input.values, label="Temperature measured", color=tb.plot.Colors.green, linewidth=2, fmt="--"),
         tb.plot.Entry(model.components["office_temperature_sensor"].output["measuredValue"].history(), label="Temperature simulated", color=tb.plot.Colors.green, linewidth=1.5),
         tb.plot.Entry(model.components["office_valve_position_sensor"].time_series_input.values, label="Valve position measured", color=tb.plot.Colors.blue, linewidth=2, fmt="--", axis=2),
         tb.plot.Entry(model.components["office_valve_position_sensor"].output["measuredValue"].history(), label="Valve position simulated", color=tb.plot.Colors.blue, linewidth=1.5, axis=2),
    ...
    fig, axes = tb.plot.plot(
        simulator.date_time_steps,
        [tb.plot.Entry(model.components["office_co2_sensor"].time_series_input.values, label=r"CO$_2$ concentration measured", color=tb.plot.Colors.green, linewidth=2, fmt="--"),
         tb.plot.Entry(model.components["office_co2_sensor"].output["measuredValue"].history(), label=r"CO$_2$ concentration simulated", color=tb.plot.Colors.green, linewidth=1.5),
         tb.plot.Entry(model.components["office_damper_position_sensor"].time_series_input.values, label=r"Damper position measured", color=tb.plot.Colors.blue, linewidth=2, fmt="--", axis=2),
         tb.plot.Entry(model.components["office_damper_position_sensor"].output["measuredValue"].history(), label=r"Damper position simulated", color=tb.plot.Colors.blue, linewidth=1.5, axis=2),
         tb.plot.Entry(model.components["office"].input["numberOfPeople"].history(), label=r"Number of people", color=tb.plot.Colors.red, linewidth=1.5, axis=2),
         tb.plot.Entry(model.components["office_occupancy_detector"].output["occupancySignal"].history(), label=r"Occupancy signal", color=tb.plot.Colors.purple, linewidth=1.5, axis=2)],
        # tb.plot.Entry(heating_controller.input["setpointValue"].history(), label="Heating setpoint", color=tb.plot.Colors.red, linewidth=1),],
    ...
    fig, axes = tb.plot.plot(
        simulator.date_time_steps,
        [tb.plot.Entry(model.components["office_temperature_sensor"].time_series_input.values, label="measured", color=tb.plot.Colors.green, linewidth=1, fmt="--"),
         tb.plot.Entry(model.components["office_temperature_sensor"].output["measuredValue"].history(), label="simulated", color=tb.plot.Colors.green, linewidth=1),
         tb.plot.Entry(heating_controller.input["setpointValue"].history(), label="indoor temperature", color=tb.plot.Colors.red, linewidth=1),
         tb.plot.Entry(model.components["office_valve_position_sensor"].time_series_input.values, label="measured", color=tb.plot.Colors.purple, linewidth=1, fmt="--", axis=2),
         tb.plot.Entry(model.components["office_valve_position_sensor"].output["measuredValue"].history(), label="simulated", color=tb.plot.Colors.purple, linewidth=1, axis=2)],
        ylabel_1axis=r"Temperature [$^\circ$C]",
        ylabel_2axis="Valve position [0-1]",
    ...
    df_valve = pd.DataFrame(
        model.components["office_valve_position_sensor"].output["measuredValue"].history()[:, 0, 0],
