...
class TestOptimizer(unittest.TestCase):
    ...
    def test_optimize_damper_position(self):
        ...
        self.assertLessEqual(mean_position, 1.0, 
                       "Optimized damper position should be within valid range")
    ...
    def test_optimize_with_constraints(self):
        ...
        self.assertGreaterEqual(min_airflow, 0.019, 
                               "Airflow constraint should be satisfied")
