...
class TestSimulator(unittest.TestCase):
    ...
    def test_simulate(self):
        ...
        self.assertEqual(schedule.output["scheduleValue"].history.shape[1], expected_timesteps)
    ...
    def test_simulate_invalid_time_period(self):
        ...
        end_time = datetime.datetime(2023, 1, 1, 0, 0, 0, tzinfo=pytz.UTC)  # Before start
        step_size = 600
    ...
    def test_simulate_very_short_period(self):
        ...
        start_time = datetime.datetime(2023, 1, 1, 0, 0, 0, tzinfo=pytz.UTC)
        end_time = datetime.datetime(2023, 1, 1, 0, 0, 10, tzinfo=pytz.UTC)  # 10 seconds
