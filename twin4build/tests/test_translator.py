...
import unittest
import os
from twin4build.translator.translator import Translator, SignaturePattern, Node, Exact, Optional_, SinglePath, MultiPath
...
class TestTranslator(unittest.TestCase):
    def setUp(self):
        ...
        # Add types
        self.semantic_model.instance_graph.add((ahu_uri, core.namespace.RDF.type, core.namespace.BRICK.AHU))
        self.semantic_model.instance_graph.add((damper1_uri, core.namespace.RDF.type, core.namespace.BRICK.Damper))
        self.semantic_model.instance_graph.add((damper2_uri, core.namespace.RDF.type, core.namespace.BRICK.Damper))
        self.semantic_model.instance_graph.add((damper21_uri, core.namespace.RDF.type, core.namespace.BRICK.Damper))
        self.semantic_model.instance_graph.add((damper22_uri, core.namespace.RDF.type, core.namespace.BRICK.Damper))
        self.semantic_model.instance_graph.add((room1_uri, core.namespace.RDF.type, core.namespace.BRICK.Room))
        self.semantic_model.instance_graph.add((room2_uri, core.namespace.RDF.type, core.namespace.BRICK.Room))
        self.semantic_model.instance_graph.add((sensor1_uri, core.namespace.RDF.type, core.namespace.BRICK.Temperature_Sensor))
        self.semantic_model.instance_graph.add((sensor2_uri, core.namespace.RDF.type, core.namespace.BRICK.Temperature_Sensor))
        
        # Add relationships
        self.semantic_model.instance_graph.add((ahu_uri, core.namespace.BRICK.feeds, damper1_uri))
        self.semantic_model.instance_graph.add((ahu_uri, core.namespace.BRICK.feeds, damper2_uri))
        self.semantic_model.instance_graph.add((damper1_uri, core.namespace.BRICK.feeds, room1_uri))
        # Parallel paths to Room 2
        self.semantic_model.instance_graph.add((damper2_uri, core.namespace.BRICK.feeds, damper21_uri))
        self.semantic_model.instance_graph.add((damper2_uri, core.namespace.BRICK.feeds, damper22_uri))
        self.semantic_model.instance_graph.add((damper21_uri, core.namespace.BRICK.feeds, room2_uri))
        self.semantic_model.instance_graph.add((damper22_uri, core.namespace.BRICK.feeds, room2_uri))
        
        self.semantic_model.instance_graph.add((room1_uri, core.namespace.BRICK.hasPoint, sensor1_uri))
        self.semantic_model.instance_graph.add((room2_uri, core.namespace.BRICK.hasPoint, sensor2_uri))
    ...
    def test_exact_rule_matching(self):
        ...
        sp.add_triple(Exact(subject=node_ahu, object=node_damper, predicate=core.namespace.BRICK.feeds))
        ...
        complete_groups, incomplete = Translator._match_patterns(systems_=[DummySystem], semantic_model=self.semantic_model)
    ...
    def test_optional_rule_matching(self):
        ...
        sp.add_triple(Optional_(subject=node_ahu, object=node_fan, predicate=core.namespace.BRICK.feeds))
        sp.add_modeled_node(node_ahu)
    ...
    def test_single_path_rule_matching(self):
        ...
        sp.add_triple(SinglePath(subject=node_ahu, object=node_room, predicate=core.namespace.BRICK.feeds))
        sp.add_modeled_node(node_ahu)
    ...
    def test_multi_path_rule_matching(self):
        ...
        sp.add_triple(MultiPath(subject=node_ahu, object=node_room, predicate=core.namespace.BRICK.feeds))
        sp.add_modeled_node(node_ahu)
