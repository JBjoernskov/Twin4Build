...
def create_conda_environment():
    ...
    if result and result.returncode == 0:
        ...
        if f" {env_name} " in result.stdout or result.stdout.endswith(f" {env_name}") or result.stdout.startswith(f"{env_name} "):
...
def print_next_steps():
    ...
    print("\n2. Start developing!")
    print("   - Check out the examples in twin4build/examples/")
    print("   - Read the developer reference: docs/source/manual/developer_reference.rst")
    print("   - Run tests: python -m unittest discover twin4build/tests/")
    print("\n3. Before committing, validate your code:")
    print("   python scripts/validate_code.py        # Check code quality")
    print("   python scripts/validate_code.py --fix  # Auto-fix formatting")
    print("\n4. Testing with coverage:")
    print("   coverage run -m unittest discover twin4build/tests/")
    print("   coverage report")
    print("\n5. Building documentation:")
    print("   cd docs")
    print("   make buildapi && make html  # Linux/Mac")
    print("   .\\make buildapi && .\\make html  # Windows")
    print(f"\n6. When you're done developing:")
