#  Data-driven and Ontology-based python package for the modeling and simulation of buildings (DatOn)

[![pytest](https://github.com/JBjoernskov/Twin4Build/actions/workflows/pytest.yml/badge.svg?branch=main)](https://github.com/JBjoernskov/Twin4Build/actions/workflows/pytest.yml)

Data-driven and Ontology-based modeling and simulation of buildings (DatOn) is a python package which aims to provide a flexible and automated framework for dynamic modelling of indoor climate and energy consumption in buildings.
